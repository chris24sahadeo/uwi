% db on youtube: https://www.youtube.com/watch?v=SykxWpFwMGs&t=2136s
% db cheatsheet: http://www.newthinktank.com/2015/08/learn-prolog-one-video/
% prolog questions: http://www.ic.unicamp.br/~meidanis/courses/mc336/2009s2/prolog/problemas/
...
% using prolog
% type 'prolog' in the terminal
% load the database using [filename] without the pl extension
...
parent(albert, bob).  % albert is the parent of bob
parent(albert, betsy).
parent(albert, bill).
parent(alice , bob).
parent(alice, betsy).
...
% structures and anonymous variables (dont cares _)
customer(tom, smith, 20.55).
customer(sally, smith, 120.55).
